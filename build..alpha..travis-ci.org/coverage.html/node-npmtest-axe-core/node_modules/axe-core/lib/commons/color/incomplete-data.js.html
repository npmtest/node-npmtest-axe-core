...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-axe-core/node_modules/axe-core/lib/commons/color/incomplete-data.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-axe-core/node_modules/axe-core/lib/commons/color/incomplete-data.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-axe-core/node_modules/axe-core/lib/commons/color/</a> &#187; incomplete-data.js</div>
</div>
<div class="body">
 ...
 */
color.incompleteData = (<span class="fstat-no" title="function not covered" >function() {</span>
...
<span class="cstat-no" title="statement not covered" >	return {</span>
		 ...
		 */
		set: <span class="fstat-no" title="function not covered" >function(key, dataObj) {</span>
<span class="cstat-no" title="statement not covered" >			if (typeof key !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >				throw new Error('Incomplete data: key must be a string');</span>
			}
<span class="cstat-no" title="statement not covered" >			if (dataObj){</span>
<span class="cstat-no" title="statement not covered" >				data[key] = dataObj;</span>
			}
		},
		/**
